...
def rewrite_markdown(text: str, notebook_name: str, cell_index: int) -> str:
    ...
    text = re.sub(r"\bthe(?:\s+the)+\s+training set", "the training set", text)
    text = re.sub(r"(?<!the )training set into a number of clusters", "the training set into a number of clusters", text)
